...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800 antialiased selection:bg-brand-blue selection:text-white">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                @if(auth()->user()->is_admin)
                    <flux:navbar.item icon="cog-6-tooth" href="/admin">
                        Admin Workspace
                    </flux:navbar.item>
                @endif
            </flux:navbar>
            ...
            <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    ...
                    <flux:menu.radio.group>
                        @if(auth()->user()->is_admin)
                            <flux:menu.item href="/admin" icon="shield-check">Admin Workspace</flux:menu.item>
                        @endif
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group heading="Platform">
                    ...
                    @if(auth()->user()->is_admin)
                        <flux:navlist.item icon="cog-6-tooth" href="/admin">
                            Admin Workspace
                        </flux:navlist.item>
                    @endif
                </flux:navlist.group>
